...
export default function WebsiteVisualEditor({ mode }: { mode: "editor" | "preview" }) {
  ...
  const footerAboutText = String(settings.footerAboutText || contactDetails.businessSummary || analysis.businessSummary || `Learn more about ${businessName}.`).slice(0, 150);
