...
const trackingSources = [
  { key: "search_console", label: "Google Search Console", required: false }, { key: "ga4", label: "Google Analytics 4", required: false }, { key: "senuke_tag", label: "SEnuke AI - AI Growth Operating System Measurement Tag", required: true },
