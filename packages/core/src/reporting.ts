...
export const projectReportCatalog = [
  ...
  { type: "campaign_project", title: "Campaign or Project Report", description: "The result of one selected campaign, milestone, or project.", sections: ["Objective", "Scope and Dates", "Work Completed", "Results", "Goal Comparison", "What Worked", "What Did Not Work", "What SEnuke AI - AI Growth Operating System Learned", "Recommended Next Step"], optionalSections: ["Goal Comparison", "What Worked", "What Did Not Work", "What SEnuke AI - AI Growth Operating System Learned"], audience: ["admin", "manager", "editor", "viewer", "client_viewer"], agencyOnly: true, clientSafe: true },
