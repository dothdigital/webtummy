export const projectReportTypes = ["executive_summary", "strategy", "seo_audit", "seo_performance", "local_seo", "reputation", "execution", "content_publishing", "ecommerce", "agency_client", "agency_proposal"] as const;
