...
export const projectReportCatalog = [
  ...
  { type: "monthly_growth", title: "Monthly Growth Report", description: "The complete monthly picture across applicable growth areas.", sections: ["Executive Summary", "Work Completed", "Important Results", "SEO & Website Progress", "Local Visibility", "Leads & Conversions", "Wins and Problems", "Next Best Action", "Next Period"], optionalSections: ["SEO & Website Progress", "Local Visibility", "Leads & Conversions", "Next Period"], audience: ["admin", "manager", "editor", "viewer", "client_viewer"], agencyOnly: false, clientSafe: true },
